...
const HEADERS = [
  "id", "createdAt", "updatedAt", "projectName", "tagline", "teamName",
  "tracks", "contractAddress", "network", "problemStatement", "solution",
  "description", "githubUrl", "demoVideoUrl", "demoUrl", "teamMembers",
  "extraLinks", "email", "logoUrl", "editCodeHash",
];
...
if (!Array.isArray(items) || items.length === 0) die("File lokal kosong, tidak ada yang dimigrasi.");
