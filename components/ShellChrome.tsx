        ...
        return (
          <Link
            ...
            className={`chamfer-sm px-2.5 py-1.5 text-[11px] font-medium uppercase tracking-[0.14em] transition ${
              active
                ? "bg-teal text-white"
                : "text-neutral-500 hover:bg-haze hover:text-teal"
            }`}
          >
            {l}
          </Link>
      ...
      <nav className="absolute left-1/2 top-0 z-40 hidden -translate-x-1/2 md:flex">
        <div className="relative flex items-center gap-6 rounded-b-[28px] bg-white px-6 py-4 lg:gap-10 lg:px-10">
          ...
          <span
            ...
            style={{
              maskImage:
                "radial-gradient(circle at 0 100%, transparent 24px, black 25px)",
              WebkitMaskImage:
                "radial-gradient(circle at 0 100%, transparent 24px, black 25px)",
            }}
          />
          <span
            ...
            style={{
              maskImage:
                "radial-gradient(circle at 100% 100%, transparent 24px, black 25px)",
              WebkitMaskImage:
                "radial-gradient(circle at 100% 100%, transparent 24px, black 25px)",
            }}
          />
      ...
      <div className="absolute inset-x-0 top-0 z-40 flex items-start justify-between md:hidden">
        ...
        >
          ...
          <span className="leading-none">
            ...
            <span className="-mt-0.5 block text-[10px] font-light opacity-80">
              {brand.line2}
            </span>
          </span>
        </Link>
