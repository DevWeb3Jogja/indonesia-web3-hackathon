    ...
    >
        ...
        <div>
          <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
            ...
            <AddButton
              label={t.addLink}
              onClick={() =>
                set("extraLinks", [...data.extraLinks, { label: "", url: "" }])
              }
            />
          </div>
      ...
      <Section n="5" title={t.section5}>
        ...
        <div>
          ...
          />
          {mode === "create" && (
            <p className="mt-1.5 text-xs text-ink/55">{t.emailHint}</p>
          )}
        </div>
      </Section>
      ...
      <button
        type="submit"
        disabled={submitting}
        className="btn-teal w-full !py-4 !text-xs"
      >
