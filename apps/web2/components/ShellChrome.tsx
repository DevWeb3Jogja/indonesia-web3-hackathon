        ...
        return (
          <Link
            ...
            className={`chamfer-sm px-2.5 py-1.5 text-[11px] font-medium uppercase tracking-[0.14em] transition ${
              active ? "bg-black text-white" : "text-neutral-500 hover:bg-black/10 hover:text-black"
            }`}
          >
            {l}
          </Link>
    ...
    <>
      ...
      <div className="absolute right-0 top-0 z-40 hidden items-center gap-3 rounded-bl-[24px] bg-white py-3 pl-4 pr-4 md:flex">
        <JudgeNavLink
          locale={locale}
          label={t.judge}
          className="text-[11px] font-medium uppercase tracking-[0.14em] text-black transition hover:opacity-70"
        />
        <AuthNavLink
          locale={locale}
          href="/team"
          label={t.team}
          className="text-[11px] font-medium uppercase tracking-[0.14em] text-neutral-800 transition hover:text-black"
        />
        <AuthNavLink
          locale={locale}
          href="/profile"
          ...
          className="text-[11px] font-medium uppercase tracking-[0.14em] text-neutral-800 transition hover:text-black"
        />
        <ConnectWalletButton className="rounded-full bg-black px-3 py-1.5 text-[11px] font-medium uppercase tracking-[0.14em] text-white transition hover:opacity-80" />
      ...
      <div className="absolute inset-x-0 top-0 z-40 flex items-start justify-between md:hidden">
        <Link
          ...
          className="flex items-center gap-2 rounded-br-[24px] bg-white py-3 pl-4 pr-5 text-black"
        >
        ...
        <button
          ...
          aria-expanded={open}
          className="flex h-[52px] w-[52px] items-center justify-center rounded-bl-[24px] bg-white text-black"
        >
          <svg
            width="20"
            height="20"
